...
var insertOnePlaybook = function (data, callback) {
    ...
    MongoClient.connect(url, function(err,db) {
        ...
        playbookDetails.maps = [{mapName: "Inferno",playlistId: new ObjectID(),plays: []},{mapName: "Dust2", playlistId:new ObjectID(),plays: []},
                                {mapName: "Mirage",playlistId: new ObjectID(),plays: []},{mapName: "Train", playlistId:new ObjectID(),plays: []}];
...
var aggregatePlaybookData = function(docToReturn, callback) {
    MongoClient.connect(url, function(err,db) {
        var playlistCollection = db.collection("playlists");
        var playCollection = db.collection("plays");    
